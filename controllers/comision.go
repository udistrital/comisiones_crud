...
// @Success 201 {int} models.Comision
// @Failure 403 body is empty
// @router / [post]
func (c *ComisionController) Post() {
	var v models.Comision
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddComision(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Comision by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Comision
// @Failure 403 :id is empty
// @router /:id [get]
func (c *ComisionController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetComisionById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 403
// @router / [get]
func (c *ComisionController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllComision(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
// Put ...
// @Title Put
// @Description update the Comision
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Comision	true		"body for Comision content"
// @Success 200 {object} models.Comision
// @Failure 403 :id is not int
// @router /:id [put]
func (c *ComisionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Comision{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaCreacion = time_bogota.TiempoCorreccionFormato(v.FechaCreacion)
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateComisionById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the Comision
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *ComisionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteComision(id); err == nil {
