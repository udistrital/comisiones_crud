...
func init() {
	...
	beego.GlobalControllerRouter["github.com/udistrital/comisiones_crud/controllers:EstadoDocumentoComisionController"] = append(beego.GlobalControllerRouter["github.com/udistrital/comisiones_crud/controllers:EstadoDocumentoComisionController"],
		beego.ControllerComments{
			Method:           "Post",
			Router:           "/",
			AllowHTTPMethods: []string{"post"},
