...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/comisiones_crud/controllers:RolUsuarioController"] = append(beego.GlobalControllerRouter["github.com/udistrital/comisiones_crud/controllers:RolUsuarioController"],
        beego.ControllerComments{
            Method: "Post",
            Router: "/",
            AllowHTTPMethods: []string{"post"},
